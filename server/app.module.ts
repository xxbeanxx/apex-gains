...
import { appConfig, coreConfig, databaseConfig, googleOAuthConfig, sessionConfig, testLoginConfig } from './config/app.config';
...
@Module({
  imports: [
    ConfigModule.forRoot({
      ...
      load: [appConfig, coreConfig, databaseConfig, googleOAuthConfig, sessionConfig, testLoginConfig],
    }),
    LoggingModule,
    ReactRouterModule,
  ],
