...
import { ConsistencyHeatmap } from '~web/components/history/consistency-heatmap';
import { ExerciseProgressChart } from '~web/components/history/exercise-progress-chart';
import { MuscleBalanceChart } from '~web/components/history/muscle-balance-chart';
import { PersonalRecordsList } from '~web/components/history/personal-records-list';
import { WeeklyBarChart } from '~web/components/history/weekly-bar-chart';
import { Card, CardAction, CardContent, CardDescription, CardHeader, CardTitle } from '~web/components/ui/card';
