...
import { formatMetricValue, paddedAxis } from '~web/components/history/chart-utils';
import { type ChartConfig, ChartContainer, ChartTooltip, ChartTooltipContent } from '~web/components/ui/chart';
