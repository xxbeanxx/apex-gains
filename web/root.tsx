...
import '~web/app.css';
import { loadUserMiddleware } from '~web/auth/current-user';
import { userContext } from '~web/auth/user-context';
import { ErrorPage } from '~web/components/error-page';
import { NavProgress } from '~web/components/nav-progress';
import { AppShell } from '~web/components/shell/app-shell';
import { sidebarInitScript } from '~web/components/shell/shell-init';
import { themeInitScript } from '~web/components/theme-toggle';
import { VersionCheck } from '~web/components/version-check';
import { getBuildInfo } from '~web/lib/build-info';
import { requestLoggingMiddleware } from '~web/lib/logger';
