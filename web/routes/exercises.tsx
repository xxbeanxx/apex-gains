...
import { EquipmentDialog } from '~web/components/exercises/equipment-dialog';
import { ExerciseCard } from '~web/components/exercises/exercise-card';
import { type ExerciseSource, SOURCE_LABEL, sourceOf } from '~web/components/exercises/exercise-source';
import { ExerciseTableRow } from '~web/components/exercises/exercise-table-row';
import { NewExerciseDialog } from '~web/components/exercises/new-exercise-dialog';
import { Page, PageHeader } from '~web/components/layout/page';
import { Button } from '~web/components/ui/button';
import { EmptyState } from '~web/components/ui/empty-state';
import { FacetFilter, type FacetOption } from '~web/components/ui/facet-filter';
...
import { optionalTrim, trim } from '~web/lib/validate-form';
import { exerciseLibraryServiceContext } from '~web/router/load-context';
