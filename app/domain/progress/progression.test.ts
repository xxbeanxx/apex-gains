...
function set(overrides: { reps?: number; weightLb?: number; minutes?: number; kmh?: number } = {}): LoggedSet {
  ...
  return LoggedSet.of({
    ...
    weight: overrides.weightLb !== undefined ? Weight.lb(overrides.weightLb) : null,
    duration: overrides.minutes !== undefined ? Duration.minutes(overrides.minutes) : null,
    speed: overrides.kmh !== undefined ? Speed.kmh(overrides.kmh) : null,
